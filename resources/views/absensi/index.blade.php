            ...
            <div class="section-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('absensi.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-primary mr-1 btn-submit" type="submit" id="submit"><i
                ...
                @can('absensi.riwayat')
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('absensi.exportPDF') }}">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-danger"><i class="fa fa-print"></i> PRINT PDF
                                            </button>

                                            <button type="submit" class="btn btn-success"><i class="fa fa-print"></i> PRINT
                                                    EXCEL
                                                </button>
                                        </div>
                                    </div>
